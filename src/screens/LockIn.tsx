  ...
  if (locked) return (
    <div style={{
      ...
      <div style={{
        ...
        marginBottom: 20, boxShadow: '0 8px 32px rgba(248,168,194,0.4)',
      }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fdf4f8' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: -30, right: -30, width: 120, height: 120, borderRadius: '50%', background: 'rgba(248,168,194,0.15)' }} />
        <div style={{ position: 'absolute', bottom: -20, left: -10, width: 80, height: 80, borderRadius: '50%', background: 'rgba(216,180,254,0.12)' }} />
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
          <div style={{ background: 'rgba(55,65,81,0.1)', borderRadius: 10, padding: '6px 8px', display: 'flex', alignItems: 'center' }}>
            <Zap size={18} color={PLUM} />
          </div>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: PLUM, margin: 0 }}>Lock In Your Look</h1>
        </div>
        <p style={{ color: 'rgba(55,65,81,0.6)', fontSize: 13, margin: 0, lineHeight: 1.5 }}>
      ...
      <div style={{ padding: '0 16px 100px', marginTop: -18 }}>
        ...
        <div style={{
          ...
          {peers.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '16px 0', color: 'rgba(55,65,81,0.4)', fontSize: 13, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              <Lock size={14} color="rgba(55,65,81,0.3)" />
          ...
          {loading ? (
            <>
              <span style={{
                ...
                border: '2px solid rgba(55,65,81,0.2)', borderTop: `2px solid ${PLUM}`,
