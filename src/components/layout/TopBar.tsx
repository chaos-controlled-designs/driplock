    ...
    <header className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] z-40 bg-white/90 backdrop-blur-sm border-b border-primary/15 px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <div className="w-7 h-7 rounded-full bg-gradient-to-br from-primary to-lavender flex items-center justify-center shadow-glow">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#3f2a2a" strokeWidth="2.5" strokeLinecap="round">
      ...
      <button
        ...
        className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-lavender flex items-center justify-center shadow-glow text-plum text-xs font-bold"
      >
        {initials}
      </button>
    </header>
