...
export function BottomNav({
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] z-40 bg-white/97 backdrop-blur-md border-t border-primary/12 flex items-end px-3 pt-2.5 pb-6">
      {tabs.map((tab) => {
